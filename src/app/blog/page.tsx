    ...
    <div className="animate-fade-in">
      ...
      <BentoGrid>
        {articles.map((article, index) => {
          ...
          return (
            <Link key={article.slug} href={`/blog/${article.slug}`} className={`group relative overflow-hidden rounded-[var(--radius)] bg-[var(--color-card)] p-4 transition-all duration-300 ease-out hover:scale-[1.02] hover:shadow-[0_12px_24px_-8px_rgba(45,27,6,0.12)] sm:p-5 ${sizeClass}`}>
