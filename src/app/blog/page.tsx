    ...
    <div className="animate-fade-in">
      ...
      <BentoGrid>
        {articles.map((article, index) => {
          ...
          return (
            <Link key={article.slug} href={`/blog/${article.slug}`} className={`group relative overflow-hidden rounded-[var(--radius)] bg-white p-4 transition-all duration-300 ease-out hover:scale-[1.02] hover:shadow-lg sm:p-5 ${sizeClass}`}>
